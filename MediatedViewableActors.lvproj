		...
		<Item Name="GPM Packages" Type="Folder">
			...
			<Item Name="@cs" Type="Folder">
				...
				<Item Name="event-logger" Type="Folder">
					<Item Name="Examples" Type="Folder">
						<Item Name="Many Modules Example.vi" Type="VI" URL="../gpm_packages/@cs/event-logger/Examples/Many Modules Example.vi"/>
						<Item Name="Singleton Log Example.vi" Type="VI" URL="../gpm_packages/@cs/event-logger/Examples/Singleton Log Example.vi"/>
						<Item Name="Test Panel.vi" Type="VI" URL="../gpm_packages/@cs/event-logger/Examples/Test Panel.vi"/>
					</Item>
					<Item Name="Source" Type="Folder">
